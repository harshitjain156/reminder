...
import 'package:reminder/controller/task_controller.dart';
import 'package:reminder/data/entity/color_task_type.dart';
import 'package:reminder/data/entity/task.dart';
import 'package:reminder/data/entity/time_mode.dart';
import 'package:reminder/service/notify_service.dart';
import 'package:reminder/ui/colors.dart';
import 'package:reminder/ui/text_theme.dart';
import 'package:reminder/ui/widget/button.dart';
...
class _AddTaskScreenState extends State<AddTaskScreen> {
  ...
  void _addTaskToDb() async {
    ...
    final theDate=DateFormat.yMd().format(_selectDate);
    final date=theDate.split("/");
    notifyService.scheduledNotificationTime(nhour!, nmin!,int.parse(date[2]),int.parse(date[0]),int.parse(date[1]),titleController.text,noteController.text);
